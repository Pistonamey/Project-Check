package com.example.projectcheck.adapters
...
import com.example.projectcheck.activities.TaskListActivity
import com.example.projectcheck.models.Task
import kotlinx.android.synthetic.main.item_task.view.*
import java.util.*
import kotlin.collections.ArrayList

open class TaskListItemAdapters(private val context: Context,
    ...
    override fun onBindViewHolder(
        ...
        if (holder is MyViewHolder) {
            ...
            holder.itemView.ib_done_edit_list_name.setOnClickListener {
                ...
                Log.i("Updated list name", "$listName")
                if (listName.isNotEmpty()) {
                    if (context is TaskListActivity) {
            ...
            holder.itemView.ib_done_card_name.setOnClickListener {
                ...
                Log.i("Updated list name", "$cardName")
